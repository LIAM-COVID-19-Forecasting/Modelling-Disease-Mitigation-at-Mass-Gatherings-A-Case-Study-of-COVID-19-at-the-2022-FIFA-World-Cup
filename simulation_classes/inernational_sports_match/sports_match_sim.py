...
Creation:
    ...
    Date: 2022-09-27
Description: A class for running world cup match MGE modelling simulations.

Classes
-------
SportMatchMGESimulation
...
# Load metapopulation information.
        ...
        if return_full_results:
            if save_dir is None:
                ...
                if 'Sample Number' in parameters:
                    solution.to_csv(save_dir+'/Solution ' + str(parameters['Sample Number'])+ '.csv', index = False, header=True)
