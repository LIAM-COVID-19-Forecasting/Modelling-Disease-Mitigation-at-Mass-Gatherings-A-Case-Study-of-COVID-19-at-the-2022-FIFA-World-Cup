...
Creation:
    ...
    Date: 10/08/2022
Description: Classes for simulating models between events that change parameter values or transfer people between states.
...
class EventQueue:
    """
    Event queue events are ordered in queue lowest to highest time. User defined method simulates model between events.
